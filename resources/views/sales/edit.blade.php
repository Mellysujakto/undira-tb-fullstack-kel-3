    ...
    <div class="container">
        ...
        <form action="{{action('SalesController@update',$id)}}" method="post">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control" name="nama_sales" id="nama_sales" value="{{$product->nama_sales}}">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="no_hp" class="col-2 col-form-label">HP</label>
                <div class="col-10">
                    <input type="text" class="form-control" name="no_hp" id="no_hp" value="{{$product->no_hp}}">
                </div>
            </div>
