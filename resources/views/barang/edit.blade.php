...
<div class="col-10">
<input type="text" class="form-control" name="kode_barang" id="kode_barang" value="{{$product->kode_barang}}">
</div>
</div>
<div class="mb-3 row">
<label for="nama_barang" class="col-2 col-form-label">Nama Barang</label>
<div class="col-10">
<input type="text" class="form-control" name="nama_barang" id="nama_barang" value="{{$product->nama_barang}}">
</div>
</div>
<div class="mb-3 row">
...
<div class="col-10">
<input type="number" class="form-control" name="harga_barang" id="harga_barang" value="{{$product->harga_barang}}">
</div>
</div>
