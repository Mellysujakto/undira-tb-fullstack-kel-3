...
<td><a href="{{action('OutletController@edit', $product['id'])}}" class="btn btn-warning">Ubah</a>
</td>
<td>
...
<div>
<a name="" id="" class="btn btn-primary" href="outlet/create" role="button">Tambah Data Outlet</a>
</div>
